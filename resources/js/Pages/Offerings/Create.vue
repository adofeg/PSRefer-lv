...
const addCommissionRule = () => {
    form.commission_rules.push({
        ...
        label: '',
        roles: '' // Comma separated Roles (e.g. Realtor, Accountant)
    });
};
            ...
            <Card>
                <form @submit.prevent="submit" class="space-y-6">
                            ...
                            <div v-for="(rule, index) in form.commission_rules" :key="index" class="bg-slate-50 p-5 rounded-2xl border border-slate-200">
                                <div class="grid grid-cols-1 md:grid-cols-12 gap-4 items-end">
                                    ...
                                    <div class="md:col-span-3">
                                        ...
                                        <input v-model="rule.roles" type="text" class="w-full text-sm border-slate-300 rounded-lg p-2" placeholder="Realtor, Accountant" />
                                    </div>
                                    <div class="md:col-span-2">
                    ...
                    <div class="flex justify-end gap-3 pt-6 border-t border-slate-100">
                        ...
                        <button type="submit" class="bg-indigo-600 text-white px-10 py-2.5 rounded-xl hover:bg-indigo-700 font-black text-sm uppercase tracking-wide transition shadow-lg shadow-indigo-200" :disabled="form.processing">
