...
import { DollarSign, TrendingUp, Clock, CheckCircle, Calendar, User, Building2, CreditCard, Hash, Search, X } from 'lucide-vue-next';
                ...
                <div class="p-8 border-b border-slate-100 flex justify-between items-center bg-slate-50/30">
                    ...
                    <div class="flex items-center gap-3">
                        <div class="flex items-center gap-2 bg-white border border-slate-200 rounded-2xl px-4 py-2 shadow-sm">
                            ...
                            <input v-model="dateFrom" type="date" class="bg-transparent border-none text-xs font-black text-slate-700 focus:ring-0 p-0" title="Desde" />
                            <span class="text-slate-300">|</span>
                            <input v-model="dateTo" type="date" class="bg-transparent border-none text-xs font-black text-slate-700 focus:ring-0 p-0" title="Hasta" />
                        </div>
