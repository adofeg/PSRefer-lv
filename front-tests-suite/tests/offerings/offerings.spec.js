                        ...
                        await route.fulfill({
                            ...
                            body: JSON.stringify({
                                ...
                                props: {
                                    offerings: {
                                        data: [
                                            { id: 1, name: 'Mock Offering 1', description: 'Desc 1', type: 'service', base_commission: 10 },
                                            { id: 2, name: 'Mock Offering 2', description: 'Desc 2', type: 'product', base_commission: 15 }
                                        ],
                                        links: []
                                    },
                                    filters: {}
