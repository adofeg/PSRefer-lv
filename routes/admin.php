...
Route::middleware(['auth', 'verified', 'role:' . implode('|', RoleName::adminOrPsAdmin())])
    ...
    // Audit Logs
    Route::get('/audit-logs', [\App\Http\Controllers\Private\Admin\AuditController::class, 'index'])->name('audit-logs.index');
    ...
    Route::get('/commissions', [\App\Http\Controllers\Private\Admin\CommissionController::class, 'index'])->name('commissions.index');
    Route::get('/commissions/create', [\App\Http\Controllers\Private\Admin\CommissionController::class, 'create'])->name('commissions.create');
    Route::get('/commissions/report', [\App\Http\Controllers\Private\Admin\CommissionController::class, 'report'])->name('commissions.report');
    Route::post('/commissions', [\App\Http\Controllers\Private\Admin\CommissionController::class, 'store'])->name('commissions.store');
    Route::get('/commissions/{commission}/edit', [\App\Http\Controllers\Private\Admin\CommissionController::class, 'edit'])->name('commissions.edit');
    Route::put('/commissions/{commission}', [\App\Http\Controllers\Private\Admin\CommissionController::class, 'update'])->name('commissions.update');
    Route::delete('/commissions/{commission}', [\App\Http\Controllers\Private\Admin\CommissionController::class, 'destroy'])->name('commissions.destroy');
